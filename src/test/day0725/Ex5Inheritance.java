...
class Super5 {
	...
	public Super5(String writer) { //writer만 체크
		super();
		this.writer = writer;
	}

	public Super5(String writer, String job) { //둘다 체크
		this.writer = writer;
		this.job = job;
	}
...
class Worker extends Super5 {
	...
	public Worker(String writer) { // 부모껄 받아서 전달
		super(writer);
	}
	...
	//부모한테서 toString 없으면 메서드에서 getter 선택해도됨
	@Override
	public String toString() {
